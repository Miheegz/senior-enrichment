...
module.exports = app
  ...
  .use(bodyParser.json())
  .use('/bootstrap', express.static(resolve(__dirname, '..', 'node_modules/bootstrap'))) // Serve static files from ../public
  .use('/jquery', express.static(resolve(__dirname, '..', 'node_modules/jquery'))) // Serve static files from ../public
